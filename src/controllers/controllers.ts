...
export const rootRoute = async (_req: Request, res: Response) => {
    try {
...
export const postUsersRoute  =  async (req: Request, res: Response) => {
    try {
...
export const putUsersRoute = async (req: Request, res: Response) => {
    const id = req?.params?.id
...
export const deleteUsersRoute = async (req: Request, res: Response) => {
    const id = req?.params?.id
